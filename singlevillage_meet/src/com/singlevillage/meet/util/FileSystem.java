...
public class FileSystem {
    ...
    {
        if (IOUtil.isExternalStorageMounted()) {
    ...
    public static File getProperCacheDirectory(final Context context, final String subdir)
    {
    	if (IOUtil.isExternalStorageMounted())
    	{
    		return getExternalCacheDirectory(context, subdir);
    	}
    	else
    	{
    		return getInternalCacheDirectory(context, subdir);
    	}
    }
    
    public static File getProperDirectory(final Context context, final String subdir)
    {
    	if (IOUtil.isExternalStorageMounted())
    	{
    		return getExternalDirectory(context, subdir);
    	}
    	else
    	{
    		return getInternalDirectory(context, subdir);
    	}
    }
}